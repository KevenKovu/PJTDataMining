...
df = pd.read_csv(csv_path, usecols=["V0001", "C006", "C008", "Q00201"], encoding="latin1", engine="c", dtype={"V0001": "Int64", "C006": "Int64", "C008": "Int64", "Q00201": "Int64"}, na_values=["NA", "", " ", "nan"])
...
pop = df[df["C008"].between(25, 59, inclusive="both") & df["C006"].isin([1, 2]) & df["Q00201"].notna()].copy()
